...
module EasyBimehLanding
  ...
  class InsurancePolicyPlanController < BaseController
    @instance = InsurancePolicyPlanController.new
    ...
    # سرور
    # @return BaseModelSpecialPlan response from the API call
    def get_special_plan(sub_domain,
                         x_api_key)
      # Prepare query url.
      _path_url = '/InsurancePolicyPlan/SpecialPlan'
      ...
      BaseModelSpecialPlan.from_hash(decoded)
    end
  end
end
