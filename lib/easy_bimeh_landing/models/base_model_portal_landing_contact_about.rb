...
module EasyBimehLanding
  # BaseModelPortalLandingContactAbout Model.
  class BaseModelPortalLandingContactAbout < BaseModel
    ...
    def self.from_hash(hash)
      ...
      status = hash['status']
      message = PortalLandingContactAbout.from_hash(hash['message']) if
        hash['message']
      extra_data = hash['extraData']
      exception = hash['exception']

      # Create object from extracted values.
      BaseModelPortalLandingContactAbout.new(is_success,
                                             status,
                                             message,
                                             extra_data,
                                             exception)
