...
module EasyBimehLanding
  # BaseModelLiabilityDoctorInsurance Model.
  class BaseModelLiabilityDoctorInsurance < BaseModel
    ...
    def self.from_hash(hash)
      ...
      status = hash['status']
      message = LiabilityDoctorInsurance.from_hash(hash['message']) if
        hash['message']
      extra_data = hash['extraData']
      exception = hash['exception']

      # Create object from extracted values.
      BaseModelLiabilityDoctorInsurance.new(is_success,
                                            status,
                                            message,
                                            extra_data,
                                            exception)
