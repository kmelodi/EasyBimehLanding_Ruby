...
module EasyBimehLanding
  # InsuranceDataFireInsurance Model.
  class InsuranceDataFireInsurance < BaseModel
    # TODO: Write general description for this method
    # @return [Integer]
    attr_accessor :insurance_policy_type_velue

    # TODO: Write general description for this method
    # @return [FireInsurancePolicyExtendView]
    attr_accessor :fire_insurance_policy_extend_view

    # TODO: Write general description for this method
    # @return [FireInsurancePolicyFilter]
    attr_accessor :fire_insurance_policy_filter
    ...
    def self.names
      @_hash = {} if @_hash.nil?
      @_hash['insurance_policy_type_velue'] = 'insurancePolicyTypeVelue'
      @_hash['fire_insurance_policy_extend_view'] =
        'fireInsurancePolicyExtendView'
      @_hash['fire_insurance_policy_filter'] = 'fireInsurancePolicyFilter'
      @_hash['id'] = 'id'
    ...
    def initialize(insurance_policy_type_velue = nil,
                   fire_insurance_policy_extend_view = nil,
                   fire_insurance_policy_filter = nil,
                   id = nil,
      ...
      @insurance_policy_type_velue = insurance_policy_type_velue
      @fire_insurance_policy_extend_view = fire_insurance_policy_extend_view
      @fire_insurance_policy_filter = fire_insurance_policy_filter
      @id = id
    ...
    def self.from_hash(hash)
      ...
      insurance_policy_type_velue = hash['insurancePolicyTypeVelue']
      if hash['fireInsurancePolicyExtendView']
        fire_insurance_policy_extend_view = FireInsurancePolicyExtendView.from_hash(hash['fireInsurancePolicyExtendView'])
      end
      if hash['fireInsurancePolicyFilter']
        fire_insurance_policy_filter = FireInsurancePolicyFilter.from_hash(hash['fireInsurancePolicyFilter'])
      end
      id = hash['id']
      selected_insurance_policy_has_been_changed =
      ...
      InsuranceDataFireInsurance.new(insurance_policy_type_velue,
