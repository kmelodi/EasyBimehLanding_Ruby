...
module EasyBimehLanding
  # BaseModelTravelInsurance Model.
  class BaseModelTravelInsurance < BaseModel
    ...
    def self.from_hash(hash)
      ...
      status = hash['status']
      message = TravelInsurance.from_hash(hash['message']) if hash['message']
      extra_data = hash['extraData']
      exception = hash['exception']

      # Create object from extracted values.
      BaseModelTravelInsurance.new(is_success,
                                   status,
                                   message,
                                   extra_data,
                                   exception)
