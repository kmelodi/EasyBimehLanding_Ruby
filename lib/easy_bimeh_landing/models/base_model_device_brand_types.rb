...
module EasyBimehLanding
  # BaseModelDeviceBrandTypes Model.
  class BaseModelDeviceBrandTypes < BaseModel
    ...
    # TODO: Write general description for this method
    # @return [List of DeviceBrandTypes]
    ...
    def self.from_hash(hash)
      ...
      unless hash['message'].nil?
        ...
        hash['message'].each do |structure|
          message << (DeviceBrandTypes.from_hash(structure) if structure)
        end
      end
      ...
      BaseModelDeviceBrandTypes.new(is_success,
                                    status,
                                    message,
                                    extra_data,
                                    exception)
