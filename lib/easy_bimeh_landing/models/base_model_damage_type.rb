...
module EasyBimehLanding
  # BaseModelDamageType Model.
  class BaseModelDamageType < BaseModel
    ...
    def self.from_hash(hash)
      ...
      unless hash['message'].nil?
        ...
        hash['message'].each do |structure|
          message << (DamageType.from_hash(structure) if structure)
        end
      end
      ...
      BaseModelDamageType.new(is_success,
                              status,
                              message,
                              extra_data,
                              exception)
