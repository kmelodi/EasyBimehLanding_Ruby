...
module EasyBimehLanding
  # BaseModelInsurancePolicyTracking Model.
  class BaseModelInsurancePolicyTracking < BaseModel
    ...
    def self.from_hash(hash)
      ...
      status = hash['status']
      message = InsurancePolicyTracking.from_hash(hash['message']) if
        hash['message']
      extra_data = hash['extraData']
      exception = hash['exception']

      # Create object from extracted values.
      BaseModelInsurancePolicyTracking.new(is_success,
                                           status,
                                           message,
                                           extra_data,
                                           exception)
