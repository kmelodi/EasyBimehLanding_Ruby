...
module EasyBimehLanding
  # BaseModelStatusStatusCollections Model.
  class BaseModelStatusStatusCollections < BaseModel
    ...
    # TODO: Write general description for this method
    # @return [List of StatusStatusCollections]
    ...
    def self.from_hash(hash)
      ...
      unless hash['message'].nil?
        ...
        hash['message'].each do |structure|
          message << (StatusStatusCollections.from_hash(structure) if structure)
        end
      end
      ...
      BaseModelStatusStatusCollections.new(is_success,
                                           status,
                                           message,
                                           extra_data,
                                           exception)
