...
module EasyBimehLanding
  # InsuranceDataLiabilityDoctorInsurance Model.
  class InsuranceDataLiabilityDoctorInsurance < BaseModel
    # شرایط اضافه ی بیمه نامه
    # @return [LiabilityDoctorInsurancePolicyExtendView]
    attr_accessor :liability_doctor_insurance_policy_extend_view

    # فیلتر های بیمه نامه
    # @return [LiabilityDoctorInsurancePolicyFilter]
    attr_accessor :liability_doctor_insurance_policy_filter
    ...
    def self.names
      @_hash = {} if @_hash.nil?
      @_hash['liability_doctor_insurance_policy_extend_view'] =
        'liabilityDoctorInsurancePolicyExtendView'
      @_hash['liability_doctor_insurance_policy_filter'] =
    ...
    def initialize(liability_doctor_insurance_policy_extend_view = nil,
                   liability_doctor_insurance_policy_filter = nil,
                   id = nil,
    ...
    def self.from_hash(hash)
      ...
      if hash['liabilityDoctorInsurancePolicyExtendView']
        liability_doctor_insurance_policy_extend_view = LiabilityDoctorInsurancePolicyExtendView.from_hash(hash['liabilityDoctorInsurancePolicyExtendView'])
      end
      if hash['liabilityDoctorInsurancePolicyFilter']
        liability_doctor_insurance_policy_filter = LiabilityDoctorInsurancePolicyFilter.from_hash(hash['liabilityDoctorInsurancePolicyFilter'])
      end
      id = hash['id']
      selected_insurance_policy_has_been_changed =
      ...
      InsuranceDataLiabilityDoctorInsurance.new(liability_doctor_insurance_policy_extend_view,
                                                liability_doctor_insurance_policy_filter,
                                                id,
                                                selected_insurance_policy_has_been_changed,
                                                is_paymented,
