...
module EasyBimehLanding
  # BaseModelElectronicEquipmentInsurance Model.
  class BaseModelElectronicEquipmentInsurance < BaseModel
    ...
    def self.from_hash(hash)
      ...
      status = hash['status']
      message = ElectronicEquipmentInsurance.from_hash(hash['message']) if
        hash['message']
      extra_data = hash['extraData']
      exception = hash['exception']

      # Create object from extracted values.
      BaseModelElectronicEquipmentInsurance.new(is_success,
                                                status,
                                                message,
                                                extra_data,
                                                exception)
