...
module EasyBimehLanding
  # BaseModelEarthquake Model.
  class BaseModelEarthquake < BaseModel
    ...
    def self.from_hash(hash)
      ...
      status = hash['status']
      message = Earthquake.from_hash(hash['message']) if hash['message']
      extra_data = hash['extraData']
      exception = hash['exception']

      # Create object from extracted values.
      BaseModelEarthquake.new(is_success,
                              status,
                              message,
                              extra_data,
                              exception)
