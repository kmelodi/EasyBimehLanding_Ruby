...
module EasyBimehLanding
  ...
  class InsuranceData < BaseModel
    ...
    attr_accessor :electronic_equipment_insurance_policy_extend_view

    # TODO: Write general description for this method
    # @return [ElectronicEquipmentInsurancePolicyFilter]
    attr_accessor :electronic_equipment_insurance_policy_filter
    ...
    def self.names
      @_hash = {} if @_hash.nil?
      @_hash['electronic_equipment_insurance_policy_extend_view'] =
        'electronicEquipmentInsurancePolicyExtendView'
      @_hash['electronic_equipment_insurance_policy_filter'] =
    ...
    def initialize(electronic_equipment_insurance_policy_extend_view = nil,
                   electronic_equipment_insurance_policy_filter = nil,
                   id = nil,
    ...
    def self.from_hash(hash)
      ...
      if hash['electronicEquipmentInsurancePolicyExtendView']
        electronic_equipment_insurance_policy_extend_view = ElectronicEquipmentInsurancePolicyExtendView.from_hash(hash['electronicEquipmentInsurancePolicyExtendView'])
      end
      if hash['electronicEquipmentInsurancePolicyFilter']
        electronic_equipment_insurance_policy_filter = ElectronicEquipmentInsurancePolicyFilter.from_hash(hash['electronicEquipmentInsurancePolicyFilter'])
      end
      id = hash['id']
      selected_insurance_policy_has_been_changed =
      ...
      InsuranceData.new(electronic_equipment_insurance_policy_extend_view,
                        electronic_equipment_insurance_policy_filter,
                        id,
                        selected_insurance_policy_has_been_changed,
                        is_paymented,
