...
module EasyBimehLanding
  # BaseModelTrakingCode Model.
  class BaseModelTrakingCode < BaseModel
    ...
    def self.from_hash(hash)
      ...
      unless hash['message'].nil?
        ...
        hash['message'].each do |structure|
          message << (TrackingCode.from_hash(structure) if structure)
        end
      end
      ...
      BaseModelTrakingCode.new(is_success,
                               status,
                               message,
                               extra_data,
                               exception)
