...
module EasyBimehLanding
  # BaseModelFireInsurance Model.
  class BaseModelFireInsurance < BaseModel
    ...
    def self.from_hash(hash)
      ...
      status = hash['status']
      message = FireInsurance.from_hash(hash['message']) if hash['message']
      extra_data = hash['extraData']
      exception = hash['exception']

      # Create object from extracted values.
      BaseModelFireInsurance.new(is_success,
                                 status,
                                 message,
                                 extra_data,
                                 exception)
