...
module EasyBimehLanding
  # BaseModelElevatorInsurance Model.
  class BaseModelElevatorInsurance < BaseModel
    ...
    def self.from_hash(hash)
      ...
      status = hash['status']
      message = ElevatorInsurance.from_hash(hash['message']) if
        hash['message']
      extra_data = hash['extraData']
      exception = hash['exception']

      # Create object from extracted values.
      BaseModelElevatorInsurance.new(is_success,
                                     status,
                                     message,
                                     extra_data,
                                     exception)
