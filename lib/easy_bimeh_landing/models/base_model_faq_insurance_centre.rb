...
module EasyBimehLanding
  # BaseModelFaqInsuranceCentre Model.
  class BaseModelFaqInsuranceCentre < BaseModel
    ...
    # TODO: Write general description for this method
    # @return [List of FaqInsuranceCentre]
    ...
    def self.from_hash(hash)
      ...
      unless hash['message'].nil?
        ...
        hash['message'].each do |structure|
          message << (FaqInsuranceCentre.from_hash(structure) if structure)
        end
      end
      ...
      BaseModelFaqInsuranceCentre.new(is_success,
                                      status,
                                      message,
                                      extra_data,
                                      exception)
