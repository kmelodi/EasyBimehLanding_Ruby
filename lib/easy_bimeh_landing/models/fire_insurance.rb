...
module EasyBimehLanding
  ...
  class FireInsurance < BaseModel
    ...
    # TODO: Write general description for this method
    # @return [List of InsuranceExtraCoverage]
    ...
    def self.from_hash(hash)
      ...
      # Parameter is an array, so we need to iterate through it
      insurance_extra_coverage = nil
      unless hash['insuranceExtraCoverage'].nil?
        insurance_extra_coverage = []
        hash['insuranceExtraCoverage'].each do |structure|
          insurance_extra_coverage << (InsuranceExtraCoverage.from_hash(structure) if structure)
        end
      end
      # Parameter is an array, so we need to iterate through it
      every_square_meter_coverage = nil
